...
# У нас есть список, состоящий из ряда элементов. 
# Сначала берем из него первый элемент, затем второй, потом третий и так далее. 
# С каждым элементом мы выполняем одни и те же действия в теле for. 
# Нам не надо извлекать элементы по их индексам и заботиться, на каком из них список заканчивается, 
# и следующая итерация бессмысленна. 
